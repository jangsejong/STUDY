...
parameter=[
    {"C":[0.1,1,10,100,1000,10000,20000], "kernel":["linear"], "degree":[3,4,5,6]},     #12
    {"C":[0.1,1,10,100,1000], "kernel":["rbf"], "gamma":[0.001,0.0001]},         #6
    {"C":[0.1,1,10,100,1000,10000], "kernel":["sigmoid"], "gamma":[0.01,0.001,0.0001],"degree":[3,4]}   #24
]   #총 42개
