...
# 학습에 필요없는 컬럼 리스트
cols_drop = ["id","person_prefer_f","person_prefer_g" ,"contents_open_dt", "contents_rn", "person_rn", "contents_attribute_h", "person_attribute_a_1",]
...
sample_submission
sample_submission.to_csv(DATA_PATH + "jobcare_0118_7_12.csv", index=False)  
