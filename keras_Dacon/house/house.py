...
rf_reg=RandomForestRegressor(random_state=SEED, n_estimators=30000, criterion="friedman_mse", max_depth=4, min_samples_split=2, min_samples_leaf=1,
...
# model=RandomForestRegressor(random_state=SEED, n_estimators=30000, criterion="friedman_mse", max_depth=4, min_samples_split=2, min_samples_leaf=1,
#                             min_weight_fraction_leaf=0, max_features="auto", max_leaf_nodes=None, min_impurity_decrease=0)
...
# submission.to_csv('../_data/dacon/house/house_0203_02.csv', index=False)
