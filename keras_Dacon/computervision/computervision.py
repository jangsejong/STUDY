...
for i in range(2): #2번 반복
    ...
    for i in range(0,50000,2): #2개씩 배치를 진행합니다
        ...
        mix_image, mix_label = mix_up((sample_image, sample_label), (sample_image2, sample_label2))
...
sample_submission = pd.read_csv("D:\\Study\\_data\\dacon\\사물이미지분류\\sample_submission.csv")

sample_submission.target = pred_class
sample_submission.to_csv("D:\\Study\\_data\\dacon\\사물이미지분류\\vision_0228_1.csv",index=False)
