...
tfidf_vectorizer.fit(sample_text1) #CountVectorizer 학습

print(tfidf_vectorizer.vocabulary_) #Vocabulary

sample_text2 = ["you are learning dacon data science"]

sample_vector = tfidf_vectorizer.transform(sample_text2)
print(sample_vector.toarray())

sample_text3 = ["you are learning dacon data science with news data"]

sample_vector2 = tfidf_vectorizer.transform(sample_text3)
...
submission.to_csv(path +"0404_02.csv",index=False)
