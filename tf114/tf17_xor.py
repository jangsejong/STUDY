...
w1 = tf.compat.v1.Variable(tf.compat.v1.random.normal([2,3]), name='weight1')
b1 = tf.compat.v1.Variable(tf.compat.v1.random.normal([3]), name = 'bias1')
...
w2 = tf.compat.v1.Variable(tf.compat.v1.random.normal([3,1]), name='weight2')
