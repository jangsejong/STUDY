...
def split_xy3(dataset, time_steps, y_column):                 
    ...
    for i in range(len(dataset)):
        ...
        y_end_number = x_end_number + y_column - 0    # 5 + 2 -1 = 7
...
mcp = ModelCheckpoint(monitor='val_loss', mode= 'auto', verbose=1, save_best_only=True, filepath='./_ModelCheckPoint/ss_ki_1221_Trafevol4.hdf6')
...
#model = load_model("./_ModelCheckPoint/ss_ki_1221_trafevol4.hdf5")
...
ss_ki_1221_Trafevol2
삼성예측값 :  [11026132.]
키움예측값 :  [66469.836]

ss_ki_1221_Trafevol3
삼성예측값 :  [9791792.]
키움예측값 :  [38820.37]
