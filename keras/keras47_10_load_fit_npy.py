...
# np.load('./_save_npy/keras47_5_train_x.npy')
# np.load('./_save_npy/keras47_5_train_y.npy')
# np.load('./_save_npy/keras47_5_test_x.npy')
# np.load('./_save_npy/keras47_5_test_y.npy')
...
model.load_weights("./_save_npy/keras47_5_save_weights.h5")
