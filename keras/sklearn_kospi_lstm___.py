...
dense2 = Dense(8, activation='linear', name='dense2')(dense1)
dense3 = Dense(4, activation='linear', name='dense3')(dense2)
...
dense21 = Dense(8, activation='linear', name='dense21')(dense11)
dense31 = Dense(4, activation='linear', name='dense31')(dense21)
...
'''
model = Sequential()
model.add(LSTM(16, activation='linear', input_shape=(5, 3)))
