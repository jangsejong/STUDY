...
for tr_idx, val_idx in sf.split(tr_X, tr_y):
    print('#'*250, f'CV {c}')
    model, _ = build_lgb(tr_X.iloc[tr_idx], tr_y.iloc[tr_idx], tr_X.iloc[val_idx], tr_y.iloc[val_idx], 150, 150)
...
submission.to_csv(path+'./Dacon_heart_LGBM2_03.csv')
'''
Dacon_heart_LGBM2_03
