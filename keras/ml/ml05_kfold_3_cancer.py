...
from sklearn.model_selection import train_test_split,KFold,cross_val_score,StratifiedKFold #StratifiedKFold 분류쪽에서 쓰곤 한다
...
'''
Acc : [0.87719298 0.92982456 0.95614035 0.9122807  0.91150442] 
 cross_val_score : 0.9174
