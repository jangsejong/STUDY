...
#3. 컴파일, 훈련
model.compile(loss='binary_crossentropy', optimizer='adam', metrics=['accuracy']) # 훈련에 상황만 판단
...
Epoch 126/2000
loss : [0.2297917604446411, 0.8859649300575256] # 2개이상 리스트

Epoch 92/2000
loss : [0.30516454577445984, 0.8947368264198303]
'''